...
// 
    ...
    public static void main(final String[] args) throws Exception {
        ...
        try {
            r.init();
            http://127.0.0.1:8080/dragdrop/upload.html?ctxScope=Dossiers&ctxName=MyDosier&ctxRef=123
            System.out.println("=======================================================");
            System.out.println("Jetty started, press 'x<CRLF>' in the console to stop");
            System.out.println("connect with your browser to http://localhost:"+PORT+"/dragdrop/upload.html?ctxScope=Dossiers&ctxName=MyDosier&ctxRef=123");
            System.out.println("=======================================================");
